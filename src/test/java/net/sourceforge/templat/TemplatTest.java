...
public class TemplatTest
{
    ...
    {
        assertTemplate(buildFile("AABGABGD"),
            buildFile("A@loop i: 2@A@if (true)@B@else@C@if (true)@D@else@E@end if@F@end if@G@end loop@D"));
    }

    @Test
    public void testIfTrueLoop() throws IOException, TemplateLexingException, TemplateParsingException
    {
        assertTemplate(buildFile("ABCCDH"),
            buildFile("A@if (true)@B@loop i: 2@C@end loop@D@else@E@loop i: 2@F@end loop@G@end if@H"));
    }

    @Test
    public void testIfFalseLoop() throws IOException, TemplateLexingException, TemplateParsingException
    {
        assertTemplate(buildFile("AEFFGH"),
            buildFile("A@if (false)@B@loop i: 2@C@end loop@D@else@E@loop i: 2@F@end loop@G@end if@H"));
    }
    ...
    {
        assertTemplate(buildFile("A"), buildFile("@arg0[ 0 ]@"), (Object) new String[]
        { "A" });
    }
    ...
    {
        assertTemplate(buildFile("ABCDEFGHIJ"), buildFile("@arg0@@arg1@@arg2@@arg3@@arg4@@arg5@@arg6@@arg7@@arg8@@arg9@"), "A",
            "B", "C", "D", "E", "F", "G", "H", "I", "J");
    }
    ...
    public static class W
    {
        ...
        {
            return Collections.<String> singletonList("A");
        }
    }
    ...
    {
        assertTemplate(buildFile("A"), buildFile("@arg0[0].get()@"), (Object) new X[]
        { new X() });
    }
    ...
    {
        assertTemplate(buildFile("A"), buildFile("@arg0[0][0]@"), (Object) new String[][]
        { new String[]
        { "A" } });
    }
    ...
    {
        assertTemplate(buildFile("A"), buildFile("@arg0[0][0]@"), (Object) new List[]
        { Collections.<String> singletonList("A") });
    }
    ...
    {
        assertTemplate(buildFile("A"), buildFile("@arg0[0][0]@"), Collections.<String[]> singletonList(new String[]
        { "A" }));
    }
    ...
    {
        assertTemplate(buildFile("A"), buildFile("@arg0[0][0]@"),
            Collections.<List<String>> singletonList(Collections.<String> singletonList("A")));
    }
    ...
    public void testExprTenTimesMethod() throws IOException, TemplateLexingException, TemplateParsingException
    {
        assertTemplate(
            buildFile("A"),
            buildFile("@arg0.get().toString().toString().toString().toString().toString().toString().toString().toString().toString()@"),
            new X());
    }
    ...
    {
        assertTemplate(buildFile("3"), buildFile("@arg0.length()@"), (Object) new String[]
        { "A", "B", "C" });
    }
    ...
    {
        assertTemplate(buildFile("3"), buildFile("@arg0.size()@"), (Object) new String[]
        { "A", "B", "C" });
    }
    ...
    {
        assertTemplateInclude(buildFile("AB"), buildFile("@  include XXX  (  arg0  ,  arg1  )  @"), buildFile("@arg0@@arg1@"),
            2, "A", "B");
    }
    ...
    {
        assertTemplateInclude(buildFile("A"), buildFile("@include XXX(arg0.get().get().get())@"), buildFile("@arg0@"), 1,
            new Y2());
    }
    ...
    public void testIncludeArg3Complex() throws IOException, TemplateLexingException, TemplateParsingException
    {
        ...
        assertTemplateInclude(buildFile("377"),
            buildFile("@include XXX(arg0.get(arg0.y()),arg1.x(arg1.y(),arg1.z()),arg2.get(arg2.x(arg2.y(),arg2.z())))@"),
    ...
    {
        final Xyz2 xyz = new Xyz2();
        assertTemplateInclude(
            buildFile("777"),
            buildFile("@include XXX(arg0.r()[arg0.x(arg0.y(),arg0.z())],arg1.x(arg1.y(),arg1.z()),arg2.get(arg2.x(arg2.y(),arg2.z())))@"),
            buildFile("@arg0@@arg1@@arg2@"), 3, xyz, xyz, xyz);
    }
