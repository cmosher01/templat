...
public class Num
{
    ...
    /**
     * Converts an integer from a zero-origin base to a one-origin base. In
     * other words, it adds one to the given number.
     * @param iZeroOrigin number to add one to; must be greater than or equal to
     *            zero
