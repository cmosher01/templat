 ...
 * <code>ContextStack</code> can be used by the parser to determine the value of
 * a given variable. The contexts will be searched from inner-most (at the top
 * of the stack) to outer-most (at the bottom of the stack).
 * @author Chris Mosher
 */
public class ContextStack
{
    ...
    /**
     * Gets the value of the given variable from this stack. The contexts in
     * this stack are searched from inner-most (at the top of the stack) to
     * outer-most (at the bottom of the stack). The first context that contains
     * the given variable is used, and the value of the variable in that context
     * is returned.
     ...
     * @return <code>true</code> if any context in this stack contains the
     *         variable.
     */
    ...
    /**
     * Gets the current (inner-most) context (that is, the one at the top of
     * this stack).
    ...
    /**
     * Checks if the given variable is equal to the given value in any of this
     * stack's contexts.
     * @param varName the variable to search for
     * @param test value to check for the variable being equal to
     * @return <code>true</code> if the variable is found, and contains the
     *         given value
