...
/**
 * Lexer to analyze a given template and fully tokenize its contents. Pass the
 * template to be lexed, as a {@link java.lang.CharSequence}, into the
 * constructor. Then call {@link TemplateLexer#lex lex} to perform the lexing.
 * @author Chris Mosher
 */
public class TemplateLexer
{
    ...
    {
        /** in a regular part of the file (outside of a tag) */
        IN_STRING,
        /** in a tag (flanked by at signs) */
        IN_TAG,
     ...
     * @throws TemplateLexingException invalid syntax found during lexing phase
     *             of processing template text
     */
